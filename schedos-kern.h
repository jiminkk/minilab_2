...
typedef struct process {
	...
	unsigned int p_priority;	// Highest priority = lowest number
	unsigned int p_share;		// Highest share = highest priority
	unsigned int p_num;		// Number to keep track of shares per process
