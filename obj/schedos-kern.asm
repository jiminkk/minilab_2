...
00100060 <_generic_int_handler>:
  ...
  10006c:	54                   	push   %esp
	call interrupt
  10006d:	e8 0a 01 00 00       	call   10017c <interrupt>
...
schedule(void)
{
  ...
  1000bf:	83 b8 00 72 10 00 01 	cmpl   $0x1,0x107200(%eax)
  1000c6:	75 ee                	jne    1000b6 <schedule+0x1a>
  1000c8:	e9 83 00 00 00       	jmp    100150 <schedule+0xb4>
				run(&proc_array[pid]);
		}
  ...
  1000d2:	ba 01 00 00 00       	mov    $0x1,%edx
	{
		while(1) {
			for(pid=1; pid<=NPROCS; ++pid){
				if(proc_array[pid].p_state == P_RUNNABLE)
  1000d7:	6b c8 54             	imul   $0x54,%eax,%ecx
  1000da:	83 b9 00 72 10 00 01 	cmpl   $0x1,0x107200(%ecx)
  1000e1:	75 12                	jne    1000f5 <schedule+0x59>
					run(&proc_array[pid]);
  1000e3:	6b d2 54             	imul   $0x54,%edx,%edx
  1000e6:	83 ec 0c             	sub    $0xc,%esp
  1000e9:	81 c2 b4 71 10 00    	add    $0x1071b4,%edx
  1000ef:	52                   	push   %edx
  1000f0:	e8 10 04 00 00       	call   100505 <run>
				run(&proc_array[pid]);
		}
	else if (scheduling_algorithm == 1)
	{
  ...
  10010c:	75 4d                	jne    10015b <schedule+0xbf>
  10010e:	83 c9 ff             	or     $0xffffffff,%ecx
			...
			pid = pid % NPROCS;
  100111:	bb 05 00 00 00       	mov    $0x5,%ebx
				if(proc_array[pid].p_state == P_RUNNABLE)
					run(&proc_array[pid]);
			}
		}
  ...
  100118:	83 b8 54 72 10 00 01 	cmpl   $0x1,0x107254(%eax)
  10011f:	75 0c                	jne    10012d <schedule+0x91>
  100121:	8b b0 0c 72 10 00    	mov    0x10720c(%eax),%esi
  100127:	39 f1                	cmp    %esi,%ecx
  100129:	76 02                	jbe    10012d <schedule+0x91>
  10012b:	89 f1                	mov    %esi,%ecx
  10012d:	83 c0 54             	add    $0x54,%eax
	}
	else if (scheduling_algorithm == 2)
	{
		while(1) {
			pid_t i;
			for(i=1; i<=NPROCS; ++i){
  100130:	3d a4 01 00 00       	cmp    $0x1a4,%eax
  100135:	75 e1                	jne    100118 <schedule+0x7c>
					&& proc_array[i].p_priority < lowest_val){
					lowest_val = proc_array[i].p_priority;
				}
			}
			//alternate if same priority value
			pid = pid % NPROCS;
  100137:	89 d0                	mov    %edx,%eax
  100139:	99                   	cltd   
  10013a:	f7 fb                	idiv   %ebx
			if(proc_array[pid].p_state == P_RUNNABLE
  10013c:	6b c2 54             	imul   $0x54,%edx,%eax
  10013f:	83 b8 00 72 10 00 01 	cmpl   $0x1,0x107200(%eax)
  100146:	75 ce                	jne    100116 <schedule+0x7a>
  100148:	39 88 b8 71 10 00    	cmp    %ecx,0x1071b8(%eax)
  10014e:	77 c6                	ja     100116 <schedule+0x7a>
				&& proc_array[pid].p_priority <= lowest_val){
				run(&proc_array[pid]);
  100150:	83 ec 0c             	sub    $0xc,%esp
  100153:	05 b4 71 10 00       	add    $0x1071b4,%eax
  100158:	50                   	push   %eax
  100159:	eb 95                	jmp    1000f0 <schedule+0x54>
  ...
  10015b:	8b 15 00 80 19 00    	mov    0x198000,%edx
  100161:	50                   	push   %eax
  100162:	68 c4 0a 10 00       	push   $0x100ac4
  100167:	68 00 01 00 00       	push   $0x100
  10016c:	52                   	push   %edx
  10016d:	e8 38 09 00 00       	call   100aaa <console_printf>
  100172:	83 c4 10             	add    $0x10,%esp
  100175:	a3 00 80 19 00       	mov    %eax,0x198000
  10017a:	eb fe                	jmp    10017a <schedule+0xde>
...
interrupt(registers_t *reg)
{
  ...
  10017d:	a1 c0 7b 10 00       	mov    0x107bc0,%eax
  100182:	b9 11 00 00 00       	mov    $0x11,%ecx
 *
 *****************************************************************************/
...
interrupt(registers_t *reg)
{
  100187:	56                   	push   %esi
  100188:	53                   	push   %ebx
  100189:	8b 5c 24 10          	mov    0x10(%esp),%ebx
	// Save the current process's register state
	// into its process descriptor
	current->p_registers = *reg;
  10018d:	8d 78 08             	lea    0x8(%eax),%edi
  100190:	89 de                	mov    %ebx,%esi
  100192:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)

	switch (reg->reg_intno) {
  100194:	8b 53 28             	mov    0x28(%ebx),%edx
  100197:	83 fa 31             	cmp    $0x31,%edx
  10019a:	74 2b                	je     1001c7 <interrupt+0x4b>
  10019c:	77 0c                	ja     1001aa <interrupt+0x2e>
  10019e:	83 fa 20             	cmp    $0x20,%edx
  1001a1:	74 49                	je     1001ec <interrupt+0x70>
  1001a3:	83 fa 30             	cmp    $0x30,%edx
  1001a6:	74 1a                	je     1001c2 <interrupt+0x46>
  1001a8:	eb 47                	jmp    1001f1 <interrupt+0x75>
  1001aa:	83 fa 32             	cmp    $0x32,%edx
  1001ad:	74 07                	je     1001b6 <interrupt+0x3a>
  1001af:	83 fa 33             	cmp    $0x33,%edx
  1001b2:	74 2a                	je     1001de <interrupt+0x62>
  1001b4:	eb 3b                	jmp    1001f1 <interrupt+0x75>
  ...
  1001b9:	83 ec 0c             	sub    $0xc,%esp
	...
	case INT_SYS_SET_PRIORITY:
		current->p_priority = reg->reg_eax;
  1001bc:	89 50 04             	mov    %edx,0x4(%eax)
		run(current);
  1001bf:	50                   	push   %eax
  1001c0:	eb 25                	jmp    1001e7 <interrupt+0x6b>
  ...
  1001c7:	a1 c0 7b 10 00       	mov    0x107bc0,%eax
  ...
  1001cc:	8b 53 1c             	mov    0x1c(%ebx),%edx
		...
		// (This shows you how to transfer arguments to system calls!)
		current->p_state = P_ZOMBIE;
  1001cf:	c7 40 4c 03 00 00 00 	movl   $0x3,0x4c(%eax)
		current->p_exit_status = reg->reg_eax;
  1001d6:	89 50 50             	mov    %edx,0x50(%eax)
		schedule();
  ...
  1001e1:	ff 35 c0 7b 10 00    	pushl  0x107bc0
  1001e7:	e8 19 03 00 00       	call   100505 <run>
  ...
  1001f1:	eb fe                	jmp    1001f1 <interrupt+0x75>
...
start(void)
{
  1001fc:	53                   	push   %ebx
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
		proc_array[i].p_state = P_EMPTY;
  1001fd:	bb 08 72 10 00       	mov    $0x107208,%ebx
start(void)
{
	int i;
	...
	segments_init();
  100202:	e8 dd 00 00 00       	call   1002e4 <segments_init>
	interrupt_controller_init(0);
  100207:	83 ec 0c             	sub    $0xc,%esp
  10020a:	6a 00                	push   $0x0
  10020c:	e8 ce 01 00 00       	call   1003df <interrupt_controller_init>
	console_clear();
  100211:	e8 52 02 00 00       	call   100468 <console_clear>
  ...
  100220:	68 b4 71 10 00       	push   $0x1071b4
  100225:	e8 1e 04 00 00       	call   100648 <memset>
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
		proc_array[i].p_state = P_EMPTY;
  10022a:	83 c4 10             	add    $0x10,%esp
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
  10022d:	c7 05 b4 71 10 00 00 	movl   $0x0,0x1071b4
  100234:	00 00 00 
		proc_array[i].p_state = P_EMPTY;
  100237:	c7 05 00 72 10 00 00 	movl   $0x0,0x107200
  10023e:	00 00 00 
	console_clear();
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
  100241:	c7 05 08 72 10 00 01 	movl   $0x1,0x107208
  100248:	00 00 00 
		proc_array[i].p_state = P_EMPTY;
  10024b:	c7 05 54 72 10 00 00 	movl   $0x0,0x107254
  100252:	00 00 00 
	console_clear();
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
  100255:	c7 05 5c 72 10 00 02 	movl   $0x2,0x10725c
  10025c:	00 00 00 
		proc_array[i].p_state = P_EMPTY;
  10025f:	c7 05 a8 72 10 00 00 	movl   $0x0,0x1072a8
  100266:	00 00 00 
	console_clear();
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
  100269:	c7 05 b0 72 10 00 03 	movl   $0x3,0x1072b0
  100270:	00 00 00 
		proc_array[i].p_state = P_EMPTY;
  100273:	c7 05 fc 72 10 00 00 	movl   $0x0,0x1072fc
  10027a:	00 00 00 
	console_clear();
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
  10027d:	c7 05 04 73 10 00 04 	movl   $0x4,0x107304
  100284:	00 00 00 
		proc_array[i].p_state = P_EMPTY;
  100287:	c7 05 50 73 10 00 00 	movl   $0x0,0x107350
  10028e:	00 00 00 
	for (i = 1; i < NPROCS; i++) {
  ...
  100294:	53                   	push   %ebx
  100295:	e8 82 02 00 00       	call   10051c <special_registers_init>
  ...
  10029a:	58                   	pop    %eax
  10029b:	5a                   	pop    %edx
  10029c:	8d 43 38             	lea    0x38(%ebx),%eax
		...
		// Set ESP
		proc->p_registers.reg_esp = stack_ptr;
  10029f:	89 7b 44             	mov    %edi,0x44(%ebx)
  ...
  1002aa:	46                   	inc    %esi
		...
		// Load process and set EIP, based on ELF image
		program_loader(i - 1, &proc->p_registers.reg_eip);
  1002ab:	e8 a8 02 00 00       	call   100558 <program_loader>
		proc_array[i].p_pid = i;
		proc_array[i].p_state = P_EMPTY;
	}
  ...
  1002b0:	83 c4 10             	add    $0x10,%esp
		...
		// Mark the process as runnable!
		proc->p_state = P_RUNNABLE;
  1002b3:	c7 43 4c 01 00 00 00 	movl   $0x1,0x4c(%ebx)
  1002ba:	83 c3 54             	add    $0x54,%ebx
		proc_array[i].p_pid = i;
		proc_array[i].p_state = P_EMPTY;
	}
	...
	// Set up process descriptors (the proc_array[])
	for (i = 1; i < NPROCS; i++) {
  1002bd:	83 fe 04             	cmp    $0x4,%esi
  1002c0:	75 cf                	jne    100291 <start+0x9e>
	...
	run(&proc_array[1]);
  1002c2:	83 ec 0c             	sub    $0xc,%esp
  1002c5:	68 08 72 10 00       	push   $0x107208
		proc->p_state = P_RUNNABLE;
	}
  ...
  1002ca:	c7 05 00 80 19 00 00 	movl   $0xb8000,0x198000
  1002d1:	80 0b 00 
	...
	//    7 = any algorithm that you may implement for exercise 7
	scheduling_algorithm = 0;
  1002d4:	c7 05 c4 7b 10 00 00 	movl   $0x0,0x107bc4
  1002db:	00 00 00 

	// Switch to the first process.
	run(&proc_array[1]);
  1002de:	e8 22 02 00 00       	call   100505 <run>
  1002e3:	90                   	nop
...
segments_init(void)
{
  ...
  1002e4:	b8 58 73 10 00       	mov    $0x107358,%eax
...
segments_init(void)
{
  ...
  100305:	88 15 3c 10 10 00    	mov    %dl,0x10103c
	...
	for (i = 0; i < sizeof(interrupt_descriptors) / sizeof(gatedescriptor_t); i++)
		SETGATE(interrupt_descriptors[i], 0,
  10030b:	ba c0 73 10 00       	mov    $0x1073c0,%edx
segments_init(void)
{
	int i;
...
segments_init(void)
{
  ...
  10032e:	c7 05 5c 73 10 00 00 	movl   $0x180000,0x10735c
  100335:	00 18 00 
	kernel_task_descriptor.ts_ss0 = SEGSEL_KERN_DATA;
  100338:	66 c7 05 60 73 10 00 	movw   $0x10,0x107360
  10033f:	10 00 
	...
	for (i = 0; i < sizeof(interrupt_descriptors) / sizeof(gatedescriptor_t); i++)
		SETGATE(interrupt_descriptors[i], 0,
  100341:	66 89 0c c5 c0 73 10 	mov    %cx,0x1073c0(,%eax,8)
  100348:	00 
  ...
  100367:	b8 1a 00 10 00       	mov    $0x10001a,%eax
	...
	for (i = INT_SYS_YIELD; i < INT_SYS_YIELD + 10; i++)
		SETGATE(interrupt_descriptors[i], 0,
  10036c:	ba c0 73 10 00       	mov    $0x1073c0,%edx
	for (i = 0; i < sizeof(interrupt_descriptors) / sizeof(gatedescriptor_t); i++)
		SETGATE(interrupt_descriptors[i], 0,
			SEGSEL_KERN_CODE, default_int_handler, 0);
	...
	// The clock interrupt gets special handling
	SETGATE(interrupt_descriptors[INT_CLOCK], 0,
  100371:	66 a3 c0 74 10 00    	mov    %ax,0x1074c0
  100377:	c1 e8 10             	shr    $0x10,%eax
  10037a:	66 a3 c6 74 10 00    	mov    %ax,0x1074c6
  100380:	b8 30 00 00 00       	mov    $0x30,%eax
  100385:	66 c7 05 c2 74 10 00 	movw   $0x8,0x1074c2
  10038c:	08 00 
  10038e:	c6 05 c4 74 10 00 00 	movb   $0x0,0x1074c4
  100395:	c6 05 c5 74 10 00 8e 	movb   $0x8e,0x1074c5
  ...
  1003aa:	66 89 0c c5 c0 73 10 	mov    %cx,0x1073c0(,%eax,8)
  1003b1:	00 
...
run(process_t *proc)
{
  100505:	8b 44 24 04          	mov    0x4(%esp),%eax
	current = proc;
  100509:	a3 c0 7b 10 00       	mov    %eax,0x107bc0

	asm volatile("movl %0,%%esp\n\t"
  10050e:	83 c0 08             	add    $0x8,%eax
...
special_registers_init(process_t *proc)
{
  ...
  100528:	8d 43 08             	lea    0x8(%ebx),%eax
  10052b:	50                   	push   %eax
  10052c:	e8 17 01 00 00       	call   100648 <memset>
	proc->p_registers.reg_cs = SEGSEL_APP_CODE | 3;
  100531:	66 c7 43 3c 1b 00    	movw   $0x1b,0x3c(%ebx)
	proc->p_registers.reg_ds = SEGSEL_APP_DATA | 3;
  100537:	66 c7 43 2c 23 00    	movw   $0x23,0x2c(%ebx)
	proc->p_registers.reg_es = SEGSEL_APP_DATA | 3;
  10053d:	66 c7 43 28 23 00    	movw   $0x23,0x28(%ebx)
	proc->p_registers.reg_ss = SEGSEL_APP_DATA | 3;
  100543:	66 c7 43 48 23 00    	movw   $0x23,0x48(%ebx)
	// Enable interrupts
	proc->p_registers.reg_eflags = EFLAGS_IF;
  100549:	c7 43 40 00 02 00 00 	movl   $0x200,0x40(%ebx)
}
