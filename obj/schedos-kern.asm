...
multiboot_start:
  ...
  100013:	9d                   	popf   
	call start
  100014:	e8 7c 01 00 00       	call   100195 <start>
  100019:	90                   	nop
...
00100060 <_generic_int_handler>:
  ...
  10006c:	54                   	push   %esp
	call interrupt
  10006d:	e8 b2 00 00 00       	call   100124 <interrupt>
...
schedule(void)
{
  ...
  1000d5:	6b ca 50             	imul   $0x50,%edx,%ecx
  1000d8:	83 b9 6c 70 10 00 01 	cmpl   $0x1,0x10706c(%ecx)
  1000df:	75 11                	jne    1000f2 <schedule+0x56>
					run(&proc_array[i]);
  1000e1:	6b c0 50             	imul   $0x50,%eax,%eax
  1000e4:	83 ec 0c             	sub    $0xc,%esp
  1000e7:	05 24 70 10 00       	add    $0x107024,%eax
  1000ec:	50                   	push   %eax
  1000ed:	e8 b7 03 00 00       	call   1004a9 <run>
		}
	else if (scheduling_algorithm == 1)
	{
		int i;
  ...
  100103:	8b 15 00 80 19 00    	mov    0x198000,%edx
  100109:	50                   	push   %eax
  10010a:	68 68 0a 10 00       	push   $0x100a68
  10010f:	68 00 01 00 00       	push   $0x100
  100114:	52                   	push   %edx
  100115:	e8 34 09 00 00       	call   100a4e <console_printf>
  10011a:	83 c4 10             	add    $0x10,%esp
  10011d:	a3 00 80 19 00       	mov    %eax,0x198000
  100122:	eb fe                	jmp    100122 <schedule+0x86>
...
interrupt(registers_t *reg)
{
  ...
  100125:	a1 1c 7a 10 00       	mov    0x107a1c,%eax
  10012a:	b9 11 00 00 00       	mov    $0x11,%ecx
 *
 *****************************************************************************/
...
interrupt(registers_t *reg)
{
  10012f:	56                   	push   %esi
  100130:	53                   	push   %ebx
  100131:	8b 5c 24 10          	mov    0x10(%esp),%ebx
	// Save the current process's register state
	// into its process descriptor
	current->p_registers = *reg;
  100135:	8d 78 04             	lea    0x4(%eax),%edi
  100138:	89 de                	mov    %ebx,%esi
  10013a:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)

	switch (reg->reg_intno) {
  10013c:	8b 53 28             	mov    0x28(%ebx),%edx
  10013f:	83 fa 31             	cmp    $0x31,%edx
  100142:	74 1f                	je     100163 <interrupt+0x3f>
  100144:	77 0c                	ja     100152 <interrupt+0x2e>
  100146:	83 fa 20             	cmp    $0x20,%edx
  100149:	74 43                	je     10018e <interrupt+0x6a>
  10014b:	83 fa 30             	cmp    $0x30,%edx
  10014e:	74 0e                	je     10015e <interrupt+0x3a>
  100150:	eb 41                	jmp    100193 <interrupt+0x6f>
  100152:	83 fa 32             	cmp    $0x32,%edx
  100155:	74 23                	je     10017a <interrupt+0x56>
  100157:	83 fa 33             	cmp    $0x33,%edx
  10015a:	74 29                	je     100185 <interrupt+0x61>
  10015c:	eb 35                	jmp    100193 <interrupt+0x6f>

	case INT_SYS_YIELD:
		// The 'sys_yield' system call asks the kernel to schedule
		// the next process.
		schedule();
  10015e:	e8 39 ff ff ff       	call   10009c <schedule>
  ...
  100163:	a1 1c 7a 10 00       	mov    0x107a1c,%eax
		current->p_exit_status = reg->reg_eax;
  100168:	8b 53 1c             	mov    0x1c(%ebx),%edx
		// The application stored its exit status in the %eax register
		// before calling the system call.  The %eax register has
		// changed by now, but we can read the application's value
		// out of the 'reg' argument.
		// (This shows you how to transfer arguments to system calls!)
		current->p_state = P_ZOMBIE;
  10016b:	c7 40 48 03 00 00 00 	movl   $0x3,0x48(%eax)
		current->p_exit_status = reg->reg_eax;
  100172:	89 50 4c             	mov    %edx,0x4c(%eax)
		schedule();
  100175:	e8 22 ff ff ff       	call   10009c <schedule>
  ...
  10017d:	ff 35 1c 7a 10 00    	pushl  0x107a1c
  100183:	eb 04                	jmp    100189 <interrupt+0x65>
  ...
  100188:	50                   	push   %eax
  100189:	e8 1b 03 00 00       	call   1004a9 <run>
	...
	case INT_CLOCK:
		...
		schedule();
  10018e:	e8 09 ff ff ff       	call   10009c <schedule>
  100193:	eb fe                	jmp    100193 <interrupt+0x6f>
...
start(void)
{
  ...
  100196:	bf 00 00 30 00       	mov    $0x300000,%edi
 *
 *****************************************************************************/
...
start(void)
{
  10019e:	53                   	push   %ebx
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
		proc_array[i].p_state = P_EMPTY;
  10019f:	bb 74 70 10 00       	mov    $0x107074,%ebx
start(void)
{
	int i;
	...
	segments_init();
  1001a4:	e8 df 00 00 00       	call   100288 <segments_init>
	interrupt_controller_init(0);
  1001a9:	83 ec 0c             	sub    $0xc,%esp
  1001ac:	6a 00                	push   $0x0
  1001ae:	e8 d0 01 00 00       	call   100383 <interrupt_controller_init>
	console_clear();
  1001b3:	e8 54 02 00 00       	call   10040c <console_clear>

	// Initialize process descriptors as empty
	memset(proc_array, 0, sizeof(proc_array));
  1001b8:	83 c4 0c             	add    $0xc,%esp
  1001bb:	68 90 01 00 00       	push   $0x190
  1001c0:	6a 00                	push   $0x0
  1001c2:	68 24 70 10 00       	push   $0x107024
  1001c7:	e8 20 04 00 00       	call   1005ec <memset>
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
		proc_array[i].p_state = P_EMPTY;
  1001cc:	83 c4 10             	add    $0x10,%esp
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
  1001cf:	c7 05 24 70 10 00 00 	movl   $0x0,0x107024
  1001d6:	00 00 00 
		proc_array[i].p_state = P_EMPTY;
  1001d9:	c7 05 6c 70 10 00 00 	movl   $0x0,0x10706c
  1001e0:	00 00 00 
	console_clear();
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
  1001e3:	c7 05 74 70 10 00 01 	movl   $0x1,0x107074
  1001ea:	00 00 00 
		proc_array[i].p_state = P_EMPTY;
  1001ed:	c7 05 bc 70 10 00 00 	movl   $0x0,0x1070bc
  1001f4:	00 00 00 
	console_clear();
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
  1001f7:	c7 05 c4 70 10 00 02 	movl   $0x2,0x1070c4
  1001fe:	00 00 00 
		proc_array[i].p_state = P_EMPTY;
  100201:	c7 05 0c 71 10 00 00 	movl   $0x0,0x10710c
  100208:	00 00 00 
	console_clear();
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
  10020b:	c7 05 14 71 10 00 03 	movl   $0x3,0x107114
  100212:	00 00 00 
		proc_array[i].p_state = P_EMPTY;
  100215:	c7 05 5c 71 10 00 00 	movl   $0x0,0x10715c
  10021c:	00 00 00 
	console_clear();
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
  10021f:	c7 05 64 71 10 00 04 	movl   $0x4,0x107164
  100226:	00 00 00 
		proc_array[i].p_state = P_EMPTY;
  100229:	c7 05 ac 71 10 00 00 	movl   $0x0,0x1071ac
  100230:	00 00 00 
	for (i = 1; i < NPROCS; i++) {
  ...
  100236:	53                   	push   %ebx
  100237:	e8 84 02 00 00       	call   1004c0 <special_registers_init>
  ...
  10023c:	58                   	pop    %eax
  10023d:	5a                   	pop    %edx
  10023e:	8d 43 34             	lea    0x34(%ebx),%eax
		...
		// Set ESP
		proc->p_registers.reg_esp = stack_ptr;
  100241:	89 7b 40             	mov    %edi,0x40(%ebx)
  ...
  100244:	81 c7 00 00 10 00    	add    $0x100000,%edi
  ...
  10024c:	46                   	inc    %esi
		...
		// Load process and set EIP, based on ELF image
		program_loader(i - 1, &proc->p_registers.reg_eip);
  10024d:	e8 aa 02 00 00       	call   1004fc <program_loader>
		proc_array[i].p_pid = i;
		proc_array[i].p_state = P_EMPTY;
	}
  ...
  100252:	83 c4 10             	add    $0x10,%esp
		...
		// Mark the process as runnable!
		proc->p_state = P_RUNNABLE;
  100255:	c7 43 48 01 00 00 00 	movl   $0x1,0x48(%ebx)
  10025c:	83 c3 50             	add    $0x50,%ebx
		proc_array[i].p_pid = i;
		proc_array[i].p_state = P_EMPTY;
	}
	...
	// Set up process descriptors (the proc_array[])
	for (i = 1; i < NPROCS; i++) {
  10025f:	83 fe 04             	cmp    $0x4,%esi
  100262:	75 cf                	jne    100233 <start+0x9e>
  ...
  100267:	68 74 70 10 00       	push   $0x107074
		proc->p_state = P_RUNNABLE;
	}
  ...
  10026c:	c7 05 00 80 19 00 00 	movl   $0xb8000,0x198000
  100273:	80 0b 00 
	...
	//    7 = any algorithm that you may implement for exercise 7
	scheduling_algorithm = 0;
  100276:	c7 05 20 7a 10 00 00 	movl   $0x0,0x107a20
  10027d:	00 00 00 

	// Switch to the first process.
	run(&proc_array[1]);
  100280:	e8 24 02 00 00       	call   1004a9 <run>
  100285:	90                   	nop
  100286:	90                   	nop
  100287:	90                   	nop
